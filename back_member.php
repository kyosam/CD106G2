        ...
        <main class="col-md-10 ml-sm-auto px-4">
                ...
                <div class="table-responsive">
                    <table class="table table-striped table-sm">
                        ...
                        <tbody>
                        <?php while($memRow = $member->fetch()){?>
                            <tr>
                                <td><?php echo $memRow['memNo']; ?></td>
                                <td><?php echo $memRow['memId']; ?></td>
                                <td><?php
                                    if($memRow['memStatus'] == 0){
                                    echo '停權';
                                    }else if($memRow['memStatus'] == 1){
                                    echo '正常';
                                    }
                                    ?>      
                                </td>
                                <td>
                                    <button type="button" class="btn btn-danger btn-sm">
                                        <a href="back_memberEdit.php?memNo=<?php echo $admRmemRowow['memNo']?>" class="edit">修改</a>
                                    </button>
                                </td>
                            </tr>
                            <?php } ?>
