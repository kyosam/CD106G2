...
try{
  ...
  $sql = 'select * from notecommentreport';
  $notecommRep = $pdo->query($sql);
        ...
        <main class="col-md-10 ml-sm-auto px-4">
                ...
                <div class="table-responsive">
                    <table class="table table-striped table-sm">
                        ...
                        <tbody>
                        <?php while($notecommRepRow = $notecommRep->fetch()){?>
                            <tr>
                                <td><?php echo $notecommRepRow['noteCommRepNo']; ?></td>
                                <td><?php echo $notecommRepRow['noteCommNo']; ?></td>
                                <td><?php echo $notecommRepRow['noteCommRepReson']; ?></td>
