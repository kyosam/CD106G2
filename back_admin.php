    ...
    <div class="row">
        ...
        <main id="admin" role="main" class="col-md-10 ml-sm-auto px-4">
                ...
                <div class="table-responsive">
                    <button type="button" class="btn btn-primary btn-sm"><a href="back_adminEdit.php">新增項目</a></button>
                    <table class="table table-striped table-sm">
                        ...
                        <?php while($admRow = $adm->fetch()){?>
                            <tr>
                                <td><?php echo $admRow['admNo']; ?></td>
                                <td><?php echo $admRow['admId']; ?></td>
                                <td>****</td>
                                <td><?php
                                    if($admRow['admPer'] == 0){
                                    echo '一般權限';
                                    }else if($admRow['admPer'] == 1){
                                    echo '最高權限';
                                    }
                                    ?>      
                                </td>
                                ...
                                <td>
                                    <button type="button" class="btn btn-danger btn-sm">
                                        <a href="back_adminEdit.php?admNo=<?php echo $admRow['admNo']?>" class="edit">修改</a>
                                    </button>
                                </td>
                            </tr>
                            <?php } ?>
