...
<div class="container-fluid">
    <div class="row">
        ...
        <main id="ticket" role="main" class="col-md-10 ml-sm-auto px-4">
                ...
                <button type="button" class="btn btn-primary btn-sm"><a href="back_ticketEdit.php">新增項目</a></button>
                            ...
                            <tr>
                                ...
                                <td>
                                    <button type="button" class="btn btn-danger btn-sm">
                                        <a href="back_ticketEdit.php?tktNo=<?php echo $tktRow['tktNo']?>" class="edit">修改</a>
                                    </button>
                                </td>
                            </tr>
                            <?php } ?>
